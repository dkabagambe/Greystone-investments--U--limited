  ...
  return (
    <div className="app-about">
      <div className="app-info">
        ...
        <p>
          It established the Managing Director as Mr.Julius Barohooza with the
          administration experience of over Eighteen years and having
          experienced Enginers and other Technical staff.
        </p>
        <p>
          The company is established and registered in accordance with the laws
          of uganda
        </p>
        <p>
          The favorable Investment Policy and the incentive packages encouraged
          Greystone investment Ltd to commit its resources to operate the
          company thereby,contribute/participate in the overall economic
